      ...
      function E(e, n, s, o) {
        ...
        function l() {
          ...
          for (; t; ) {
            ...
            if (o) {
              const [e, i] = o;
              if ((M.addText(n), (n = ''), (c[s] = (c[s] || 0) + 1), c[s] <= 7 && (j += i), e.startsWith('_')))
                n += t[0];
              else {
        ...
        try {
          ...
          return (
            M.finalize(), (k = M.toHTML()), { language: e, value: k, relevance: j, illegal: !1, _emitter: M, _top: N }
          );
        } catch (t) {
...
'object' == typeof exports &&
  ...
  (module.exports = hljs); /*! `typescript` grammar compiled for Highlight.js 11.10.0 */
(() => {
  var e = (() => {
    'use strict';
    ...
    function o(o) {
      ...
      const v = [].concat(h, y.contains),
        w = v.concat([{ begin: /(\s*)\(/, end: /\)/, keywords: g, contains: ['self'].concat(v) }]),
        R = {
          className: 'params',
          begin: /(\s*)\(/,
          end: /\)/,
        ...
        I = {
          match: l.concat(
            /\b/,
            ((C = [...r, 'super', 'import'].map(e => e + '\\s*\\(')), l.concat('(?!', C.join('|'), ')')),
            d,
            l.lookahead(/\s*\(/)
          ),
                ...
                contains: [
                  {
                    ...
                    variants: [
                      ...
                      { begin: /(\s*)\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: g, contains: w },
                    ],
                  },
                ],
              },
